...
@Data
@Schema(description = "服务新增")
public class ServiceGroupCmd extends Command {

    /**
     * uuid
     */
    @Schema(description = "项目分组通用唯一编码")
    private String uuid;
     ...
     * 服务分组URI
     */
    @Schema(description = "服务分组URI(分组内路径前缀)")
    private String uri;
     ...
     * 服务分组所属领域唯一标识
     */
    @Schema(description = "服务分组所属领域唯一标识")
     ...
     * 服务分组所属项目唯一标识
     */
    @Schema(description = "服务分组所属项目唯一标识")
